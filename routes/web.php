...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/incidents/view', function () {
        return Inertia::render('SeeIncidents');
    })->name('incidents.view');
    //Route::get('/incidents/general', [IncidentController::class, 'viewIncidents'])->name('incidents.view');
    Route::get('/incidents/by-municipality', action: [IncidentController::class, 'byMunicipality'])->name('incidents.byMunicipality');
    // Route::get('/incidents/by-state', [IncidentController::class, 'byState'])->name('incidents.byState');
    Route::get('/incidents/by-type', [IncidentController::class, 'byType'])->name('incidents.byType');
    Route::get('/incidents/by-status', [IncidentController::class, 'byStatus'])->name('incidents.byStatus');
    Route::get('/incidents/by-date', [IncidentController::class, 'byDate'])->name('incidents.byDate');
