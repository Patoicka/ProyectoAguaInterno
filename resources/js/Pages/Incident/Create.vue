...
onMounted(() => {
    incidentStore.incidentTypes = props.incidentTypes;

    if (!incidentStore.incidentTypeId && props.incidentTypes.length > 0) {
        incidentStore.incidentTypeId = props.incidentTypes[0].id;
    }
});
...
function moveToMap(location) {
    if (locationMapRef.value) {
        locationMapRef.value.moveToLocation(location);
    }
}
        ...
        <CardBox>
            <Tabs v-model="activeTab" variant="pills" class="p-5">
                <Tab name="general" title="Datos generales del solicitante">
                    ...
                    <div
                        class="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3 mb-5"
                    >
                        <FormField
                            label="Nombre(s):"
                            required
                            :error="form.errors.names"
                        >
                            <FormControl
                                v-model="form.names"
                        ...
                        <FormField
                            ...
                            :error="form.errors.first_surname"
                        >
                            <FormControl
                        ...
                        <FormField
                            ...
                            :error="form.errors.second_surname"
                        >
                            <FormControl
                ...
                <Tab name="images" title="Cargar imagenes">
                    <button
                        class="relative mb-4 w-32 p-2 bg-blue-700 text-white rounded"
                    >
                        Subir imagenes
                        <input
