        ...
        <section class="min-h-screen py-20 bg-white dark:bg-blue-950">
            <div
                ...
                <div class="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
                    ...
                    <form class="space-y-5" @submit.prevent="form.get(route('welcome.show.incident', { code: form.code }))">
                        <p class="dark:text-gray-400">
                            <FormField label="Código" :error="form.errors.code"
                                help="Ingresa el número de folio">
                                <FormControl v-model="form.code" placeholder="Ingresa el número de folio" :icon="mdiQrcode" />
                            </FormField>
                        </p>

                        <BaseButtons>
                            <BaseButton :class="[{ 'animate-bounce animate-twice': form.code != null }]" label="Consultar"
                                type="submit" color="info" :icon="mdiArrowRight" routeName="welcome.show.incident"
                                :parameter="form.code" />
                        </BaseButtons>
                    </form>
                </div>
                ...
                <div class="flex-none w-full block md:hidden">
                    ...
                    <div class="p-4 text-center flex items-center justify-center h-full text-white lg:bg-black/45">
                        <div class="block px-2">
                            ...
                            <Link :href="route('welcome.store.incidet')"
