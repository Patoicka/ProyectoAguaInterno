        ...
        <CardBox>
            ...
            <div class="flex flex-wrap gap-4 pb-4">
                ...
                <FormField label="Estado">
                    <FormControl :options="availableFilters.statuses" v-model="filtros.statuses"
                        @change="fetchChart(true)" />
                </FormField>
                <FormField label="Municipio">
                    <FormControl :options="availableFilters.cities" v-model="filtros.cities"
                        @change="fetchChart(true)" />
                </FormField>
        ...
        <CardBox class="mt-6">
            ...
            <div class="flex flex-wrap gap-4 mb-4">
                ...
                <FormField label="Máx filas (limit)">
                    <input v-model.number="limite" type="number" min="1"
                        class="p-2 rounded bg-gray-700 text-white w-28" />
                </FormField>
            </div>
        ...
        <CardBox class="mt-6">
            ...
            <div v-else>
                ...
                <FormField label="Máx filas (PDF/CSV)">
                    <input v-model.number="limiteSearch" type="number" min="1"
                        class="p-2 rounded bg-gray-700 text-white w-28" />
                </FormField>
