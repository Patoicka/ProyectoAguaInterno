...
<template>
  <div class="bg-white dark:bg-blue-950">
    <nav
      class="container px-6 py-8 mx-auto lg:flex lg:justify-start lg:items-center"
    >
      <div class="flex items-center justify-between lg:w-72 w-auto">
        ...
        >
          <div class="justify-normal flex items-center space-x-1">
            <ApplicationLogo
              inputClass="w-14 md:rounded-lg rounded-b-full rounded-t-lg"
            />
            <div class="text-[#737373] dark:text-white">
              <p>{{ appName() }}</p>
              <p class="text-xs">Comisión del Agua del Edomex</p>
            </div>
          </div>
        </Link>
        ...
        <div @click="toggleNav" class="flex lg:hidden">
          <BaseButton
            :icon="showMenu ? mdiClose : mdiMenu"
            color="info"
            class="text-white"
          />
        </div>
      ...
      <div
        :class="showMenu ? 'flex flex-col' : 'hidden'"
      ...
      >
        ...
        >
          <li>
            <NavLink :active="$page.component === 'Welcome/Home/Index'" href="/"
              >Inicio</NavLink
            >
          </li>
          <li>
            <NavLink
              :active="$page.component === 'Welcome/Incident/Create'"
              href="/welcome/incident/create"
            >
              Incidencias
            </NavLink>
          </li>
          <li>
            <NavLink
              :active="$page.component === 'Welcome/Incident/Search'"
              href="/welcome/incident/search"
            >
          ...
          <li>
            <NavLink
              href="https://sergiomorame.github.io/ecatepec.github.io/"
              :external="true"
            >
              Visualizador
            </NavLink>
        ...
        <div
          class="order-1 flex justify-center items-center mt-4 lg:order-2 lg:mt-0 lg:flex lg:items-center"
        >
